$.ajax({
    method:'POST',
          url:"http://localhost/G2_POO_CID_AF/etudiant/listEtuds",
          data:{search:34},
          dataType:"JSON",
...
function supprimer(e){
    ...
    if(f){
       $.ajax({
        method:'POST',
        url:"http://localhost/G2_POO_CID_AF/etudiant/deleteEtudiant",
        data:{id:id},
        dataType:'JSON',
        success:function(data){
...
$('#updateEtudiant').submit(function(e) {
    ...
    $.ajax({
        method:'POST',
        url:'http://localhost/G2_POO_CID_AF/etudiant/updateEtudiant',
        data:$(this).serialize(),
        success:function (data) {
            console.log(data)
        }
