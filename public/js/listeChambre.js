...
function liste(){
    $.ajax({
        method:'POST',
        url:"http://localhost/G2_POO_CID_AF/chambre/listeChambre",
        data:{id:4},
        dataType:'JSON',
...
function supprimer(e) {
    ...
    if(cf){
        $.ajax({
            method:'POST',
            url:"http://localhost/G2_POO_CID_AF/chambre/deleteChambre",
            data:{id:f},
            success:function(data){
                console.log(data)
            }
...
function modifier(e) {
    var f=e.getAttribute('id')
     $.ajax({
        method:'POST',
        url:"http://localhost/G2_POO_CID_AF/chambre/updateChambre",
        data:{id:f},
        dataType:'JSON',
        success:function(data){
            // alert(data.numero)
...
$('#myModif').submit(function(e) {
    ...
    $.ajax({
        method:'POST',
        url:"http://localhost/G2_POO_CID_AF/chambre/modifierChambre",
        data:$(this).serialize(),
        success:function (data) {
            console.log(data);
