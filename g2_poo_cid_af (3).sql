...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 25 juin 2020 à 22:28
...
(1, NULL, 12, 'one', 1, NULL),
(2, '0189353', 18, 'two', 1, 1),
(3, NULL, 22, 'two', 1, 1),
(4, NULL, 22, 'two', 1, 1),
...
INSERT INTO `etudiant` (`id`, `matricule`, `prenom`, `nom`, `email`, `telephone`, `date`, `adresse`, `numChambre`) VALUES
